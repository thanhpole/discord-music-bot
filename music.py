...
class Music(commands.Cog):
    ...
    @commands.command(name='oi', invoke_without_subcommand=True)
    ...
    @commands.command(name='leave', aliases=['disconnect', 'bien'])
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='now', aliases=['current', 'playing', 'np', 'nowplaying', 'hotcaigithe'])
    async def _now(self, ctx: commands.Context):
        """Displays the currently playing song."""
        embed = ctx.voice_state.current.create_embed()
        await ctx.send(embed=embed)

    @commands.command(name='pause', aliases=['pa', 'dung'])
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='resume', aliases=['re', 'res', 'tt'])
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='skip', aliases=['s', 'im'])
    ...
    @commands.command(name='play', aliases=['p', 'meow'])
    ...
    @commands.command(name='search', aliases=['tim'])
    ...
    @commands.command(name='ciu', aliases=['h', 'lenh'])
    async def _autoplay(self, ctx: commands.Context):
        await ctx.send('Ty.oi - triệu hồi bé tý\nTy.meow + link hoặc tên bài hát - thêm vào playlist và hót\nTy.cut - xóa playlist và dừng nhạc\nTy.dung - pause\nTy.tt - tiếp tục sau khi pause\nTy.autoplay - Tý hót suốt ngày\nTy.queue - hiển thị playlist\nTy.tim - tìm kiếm bài hát\nTy.loop - lặp lại bài hát đang hát\nTy.remove + số thứ tự - xóa bài hát trong playlist\nTy.shuffer - trộn bài hát trong queue\nTy.im - next bài\nTy.hotcaigithe - hiển thị bài đang hót\nTy.bien - disconnect bot')
